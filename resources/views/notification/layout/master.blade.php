...
<head>
	<meta charset="utf-8">
	<title>Sailor @yield('title')</title>
		...
		<section id="inner-headline">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<ul class="breadcrumb">
							<li><a href="#"><i class="fa fa-home"></i></a><i class="icon-angle-right"></i></li>//回首頁連結
							<li><a href="#">Features</a><i class="icon-angle-right"></i></li>//回上一層類別連結
							<li class="active">404 Not found</li>//本頁名稱
						</ul>
					</div>
				</div>
			</div>
