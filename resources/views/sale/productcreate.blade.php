...
<div class='container-fluid'>
    ...
    <h2 class=" text-right & text-danger " style="font-family:標楷體 ;position: absolute; right:200pt ">
        <strong>合計:{{$saleinfo}}元</strong></h2>
    <form action="{{route('prestore')}}" method="POST" role="form" enctype="multipart/form-data"
            ...
            <div class="modal-content">
                <div id="printModal">
                    ...
                    <div class="modal-body">
                        ...
                        <nobr>
                            <h2 class=" text-right & text-danger" style="font-family:標楷體"><strong>總計:<span
                                            id="inner"></span></strong></h2>
                        </nobr>
                ...
                <div class="modal-footer">
                    <form action="{{route('salestore')}}" method="POST" role="form" enctype="multipart/form-data"
                          onsubmit="return ConfirmCreate()">
                        {{ csrf_field() }}
                        ...
                        <div class="container ">
                            ...
                            <button type="submit" class=" btn btn-info & center-block" onclick="printDiv('printModal')">
                                列印明細
                            </button>
                        </div>
                    </form>
